MODULE NOAHMP_GLACIER_GLOBALS_401
...
!------------------------------------------------------------------------------------------!
END MODULE NOAHMP_GLACIER_GLOBALS_401
!------------------------------------------------------------------------------------------!

MODULE NOAHMP_GLACIER_ROUTINES_401
  USE NOAHMP_GLACIER_GLOBALS_401
  IMPLICIT NONE
...
! output
  ...
  REAL                           , INTENT(OUT)   :: QSNSUB  !snow surface sublimation rate [mm/s]
...
! -----------------------------------------------------------------
        ...
        MPE    = 1E-6
        DTG    = 0.
! Added initialization of MOZ - by David Mocko 02-20-2019
        MOZ    = 0.
        MOZSGN = 0
        MOZOLD = 0.
        H      = 0.
...
!S1_SNWD: Hans Lievens add condition to avoid division by zero       
...
END MODULE NOAHMP_GLACIER_ROUTINES_401
! ==================================================================================================

MODULE MODULE_SF_NOAHMP_GLACIER_401

  USE NOAHMP_GLACIER_ROUTINES_401
  USE NOAHMP_GLACIER_GLOBALS_401

END MODULE MODULE_SF_NOAHMP_GLACIER_401
